...
# Disable HAML tests since we don't use HAML in any of our templates right now.
# HAML is installed only for SASS to generate the .css files.
if defined? Haml and false
